        ...
        >
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              className="bg-gray-900 p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow"
            >
              ...
              <p className="text-gray-300 mb-6">Call us directly to place your order for collection</p>
              <Button
              ...
              >
                <a href="tel:+27616235271">
                  <Phone className="mr-2 h-4 w-4" /> 061 623 5271
                </a>
              </Button>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 mb-6">Send us a WhatsApp message with your order details</p>
              <Button
                className="bg-green-600 hover:bg-transparent hover:text-green-500 border-2 border-green-600 transition-all"
                size="lg"
                asChild
              >
                <a
